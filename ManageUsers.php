...
<main>
	<h1 class="slideInDown animated">Add a new Student or update information <br> or remove Student</h1>
	<div class="form-style-5 slideInDown animated">
		<form enctype="multipart/form-data">
			...
			<fieldset>
				...
				<input type="text" name="name" id="name" placeholder="Family Name...">
				<input type="text" name="number" id="number" placeholder="Phone Number...">
				<input type="email" name="email" id="email" placeholder="Family Email...">
			</fieldset>
			<fieldset>
			<legend><span class="number">2</span> Additional Info</legend>
			<label>
				<label for="Device"><b>Student Grade:</b></label>
                    <select class="dev_sel" name="dev_sel" id="dev_sel" style="color: #100;">
                      <option value="0">KG 1</option>
                      <option value="0">KG 2</option>
                      <option value="0">KG 3</option>
                      <option value="0">Grade 1</option>
                      <option value="0">Grade 2</option>
                      <option value="0">Grade 3</option>
                      <option value="0">Grade 4</option>
                      <option value="0">Grade 5</option>
                      <option value="0">Grade 6</option>
                      <option value="0">Grade 7</option>
                      <option value="0">Grade 8</option>
                      <option value="0">Grade 9</option>
                      <option value="0">Grade 10</option>
                      <option value="0">Grade 11</option>
